...
// ------------ SETUP TASKS -------------
// Copy Bootstrap filed into Bootstrap development folder
function setupBootstrap() {
  console.log('---------------COPYING Bootstrap FILES---------------');
  return src([nodepath + 'bootstrap/*.sass', nodepath + 'bootstrap/**/*.sass'])
...
// BUILD
const build = series(cleanDist, copyFont, copyData, jsVendor, cssVendor, copyImages, compileHTML, concatPlugins, concatCssPlugins, compileJS, resetPages, prettyHTML, compileSCSS);
exports.build = build;